#=
OPTYMALIZACJE:
- zastąpienie posługiwania się wektorem GraphNode na rzecz krotki GraphNode (wartość zwracana przez funckję graph())
- dzięki temu funkcje iterujące przez graf obliczeniowy, np. forward!, backward! wiedzą od razu z jakich węzłow składa się graf
- iterowanie odbywa się przez funkcję foreach()
=#
