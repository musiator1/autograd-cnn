#=
OPTYMALIZACJE:
- poprawne wykorzystanie cache procesora w primal! oraz adjont! dla :im2col
- zmiana dotyczy kodu w najbardziej zagłebionej pętli, gdzie zmienna patch_idx (najczęściej zmieniana)
odnosi się do wiersza (wcześniej odnosiła się do kolumny)
- w tym celu dodano operator :mul_At_w do mnożenia z transpozycja.
=#
