#=
OPTYMALIZACJE:
- dodanie typów dla pola args dla struktury GraphNode
- dodanie odzielnych typów dla pola grad oraz data dla struktury GraphNode
- przystosowanie konstruktorów do zmiany w strukturze
- usunięcie funkcji barierowych (nie były potrzebne po wprowadzeniu zmian i stanowiły zbędny narzut)
=#
