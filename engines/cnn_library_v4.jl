#=
OPTYMALIZACJE:
- zastosowanie funkcji mul!() z biblioteki LinearAlgebra
- umożliwia mnożenie macierzy z ograniczeniem alokacji pamięci do minimum
- zmiany w kodzie to dwie linijki w primal!(:mul) oraz adjoint!(:mul)
=#
